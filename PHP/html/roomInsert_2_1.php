<?php
    ...
    $sql = "INSERT INTO room(adress,detailAdress,housesort,sort_of_floor,num_of_floor,area,roomcount,toiletcount,options) 
    VALUES ('$adress','$detailAdress','$housesort','$sort_of_floor','$num_of_floor','$area', '$roomcount', '$toiletcount', '$options')";
